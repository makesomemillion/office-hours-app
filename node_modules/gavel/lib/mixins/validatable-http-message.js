...
var Validatable, jph, mediaTyper, validators;
  ...
  Validatable.prototype.setBodyRealType = function() {
    ...
    if (this.isJsonContentType(contentType)) {
      try {
        ...
        error = error1;
        message = {
          message: "Real body 'Content-Type' header is '" + contentType + "' but body is not a parseable JSON:\n" + error.message,
          severity: 'error'
        };
  ...
  Validatable.prototype.setBodyExpectedType = function() {
    ...
    if (this.expected.bodySchema != null) {
      if (typeof this.expected.bodySchema === 'string') {
        try {
          parsed = jph.parse(this.expected.bodySchema);
          if (typeof parsed !== 'object' || Array.isArray(parsed)) {
            message = {
              message: "Can't validate. Expected body JSON Schema 'Content-Type' is\nnot a parseable JSON:\n" + error.message,
              severity: 'error'
            };
            return this.validation.body.results.push(message);
          } else {
